  ...
  return (
    <>
      ...
      >
        ...
        style={{ background: "linear-gradient(275deg,  #b4902d, #8A6D1F)" }}>
        ...
        <form className="p-5" onSubmit={handleSubmit}>
            ...
            <ul className="flex flex-wrap -mb-px text-sm font-medium text-center">
              {["tab1", "tab2", "tab3", "tab4"].map((tab, idx) => {
                ...
                return (
                  <li
                    key={tab}
                    className={`me-2 hover:text-yellow-900 ${
                  ...
                  >
                    <Button
                      ...
                      className="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:border-yellow-900 group"
                    >
          ...
          <div className="relative">
            <table className="text-sm text-left text-gray-500 w-full">
              ...
              style={{ background: "linear-gradient(275deg, rgb(163, 130, 21), rgb(255, 221, 108))" }}>
                <tr>
          ...
          <div className="mt-6 text-right">
            <Button
              ...
              className="cursor-pointer text-white bg-yellow-600 hover:bg-yellow-500 px-5 py-2 rounded-lg"
            >
