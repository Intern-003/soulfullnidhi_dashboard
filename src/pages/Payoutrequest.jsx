      ...
      beneficiarydetails: (
        <div className="flex flex-col text-left">
          ...
          <span>
            ...
            <b>{row.beneficiary_mobile_no || "null"}</b>
          </span>
          <span>
    ...
    <>
      ...
      <div className="">
        ...
        >
          ...
          <Button
            type="button"
            className="bg-white border border-sky-200 text-[#3D3200] font-semibold px-4 py-1 rounded-lg shadow-md hover:bg-sky-50 hover:border-sky-300 transition-all duration-200 cursor-pointer"
