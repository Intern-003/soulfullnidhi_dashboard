...
const Payoutrequest = () => {
    ...
    const memberdata = [
      { beneficiaryid: "1", bankdetails: "Yuvraj", beneficiarydetails: "Rs.1000" },
      { beneficiaryid: "2", bankdetails: "Aakash", beneficiarydetails: "Rs.4000" },
    ];
        ...
        >
          ...
          >
            ...
            <div className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 text-white font-medium rounded-t-lg px-5 py-3 flex justify-between items-center">
              ...
              <button
                onClick={() => setShowModal(false)}
                className="flex items-center justify-center w-8 h-8 rounded-full bg-white text-black font-bold text-lg shadow hover:bg-gray-200 transition"
              >
                ✖
              </button>
            </div>
            ...
            <div className="overflow-x-auto p-4">
              <table className="w-full text-sm text-left border-collapse">
                <thead>
                  <tr style={{ backgroundColor: '#bec3ceff' }} className="font-medium">
                    <th className="p-2 border border-white text-gray-500">NAME</th>
                    <th className="p-2 border border-white text-gray-500">ACCOUNT</th>
                    <th className="p-2 border border-white text-gray-500">IFSC</th>
                    <th className="p-2 border border-white text-gray-500">BANK</th>
                  </tr>
                </thead>

                <tbody>
                  <tr style={{ backgroundColor: '#68f3b9ff' }} className="font-medium text-white">
            ...
            <form className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div> 
                  ...
                  <input id="amount" type="number" placeholder="Enter Amount" className="w-full border border-gray-300 rounded-lg p-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none"/>
                </div>

                {/* Payment Mode */}
                <div>
                  <label htmlFor="paymentMode" className="block mb-2 text-sm font-medium text-gray-900"> Payment Mode </label>
                  <select id="paymentMode" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    <option>IMPS</option>
                    <option>NEFT</option>
                    <option>UPI</option>
                    <option>RTGS</option>
              ...
              <div className="flex justify-end space-x-3 pt-4">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 text-sm font-medium rounded-lg text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300"
                >
                  Submit
                </button>
              </div>
      ...
      {showFormModal && (
        ...
        >
          ...
          >
            ...
            >
              <h4 className="font-bold text-white text-lg py-2">Add Beneficiary Details</h4>
              <button
                onClick={() => setShowFormModal(false)}
