    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-blue-100 overflow-hidden">
        ...
        <div className="flex border-b border-blue-100 bg-gradient-to-r from-blue-50 to-white">
          <button
            className={`flex-1 flex items-center justify-center gap-3 px-6 py-5 font-semibold text-base transition-all duration-200
              ${
                activeTab === "apiToken"
                  ? "text-yellow-800 bg-white border-b-4 border-yellow-900 shadow-sm"
                  : "text-gray-600 hover:bg-yellow-50/70 hover:text-yellow-700"
              }`}
            onClick={() => setActiveTab("apiToken")}
          >
        ...
        <div className="p-6 md:p-10">
          ...
          {activeTab === "apiToken" && (
            <div>
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5 mb-8">
                <h2 className="text-2xl md:text-3xl font-bold text-[#3D3200]">
                  Manage API Tokens
                </h2>
          ...
          {activeTab === "webhookConfig" && (
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-yellow-900 mb-10">
                Webhook Configuration
              </h2>
              ...
              <div className="grid grid-cols-1 gap-8">
                ...
                <div className="bg-gradient-to-br from-white to-blue-50/30 p-8 rounded-2xl shadow-lg border border-blue-100 hover:shadow-xl transition-shadow duration-300">
                  <label className="block text-xl font-semibold text-yellow-900 mb-4">
                    Payment Received Webhook URL
                  </label>
                  <div
                    className="
                  ...
                  <p className="mt-3 text-sm text-gray-600">
                    We'll send real-time POST notifications for
                    successful/failed payins to this endpoint.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-white to-blue-50/30 p-8 rounded-2xl shadow-lg border border-blue-100 hover:shadow-xl transition-shadow duration-300">
                  ...
                  <p className="mt-3 text-sm text-gray-600">
                    Real-time POST updates for payout status changes will be
                    sent here.
                  </p>
                </div>
              </div>
              ...
              <button
                ...
                className={`
                  ...
                  ${
                    WebHookLoading
                      ? "bg-blue-400 cursor-not-allowed"
                      : "bg-gradient-to-r from-[#b8962e] to-[#D4AF37] hover:from-yellow-700 hover:to-yellow-800 text-white"
                  }
                `}
              >
                {WebHookLoading ? (
