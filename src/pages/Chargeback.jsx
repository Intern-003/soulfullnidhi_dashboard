    ...
    },
    {
      ...
      Cell: ({ row }) => (
        <div className="w-70 flex flex-col">
          ...
          <span>
            chargeback id : <b>{row.chargeback_id}</b>
          </span>
          <span>
            mytxnid : <b>{row.mytxnid}</b>
          </span>

          {role === "admin" && (
            <span>
              Airpay_id : <b>{row.apitxnid}</b>
            </span>
          )}
        </div>
      ),
    ...
    },
    {
      ...
      Cell: ({ row }) => (
        <div className="flex flex-col text-left w-50">
          ...
          <span>
            {row.status.toLowerCase().trim() === "reverse"
                ...
                <div className="relative group">
                  <span
                    onClick={() => {
                      if (
                        window.confirm(
                          "Are you sure to reverse this chargeback?",
                        )
                      ) {
