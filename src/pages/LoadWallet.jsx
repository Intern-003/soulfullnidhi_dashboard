    ...
    action: (
      <div className="flex items-center justify-start gap-2">
        <Button
          ...
          className="bg-yellow-600 hover:bg-yellow-500 text-white text-sm font-medium px-4 py-1.5 rounded-md shadow-md transition-all"
        >
          Load Wallet
        </Button>
        <Button
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div
        ...
        style={{
          background: "linear-gradient(275deg, #b4902d 0%, #8A6D1F 100%)",
        }}
      >
